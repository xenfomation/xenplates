...
# XENTOOLS		: Must be manually installed
# OTHER NOTES	: XFCE menu controls/are UNUSABLE if not UNREADABLE
#
################################################################################
...
#
#dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Linux Mint 17.1 Rebecca (XFCE Spin)")
#
#xe template-param-set uuid=$dstUUID \
#	name-description="COMMUNITY TEMPLATE for Linux Mint 17.1 \"Rebecca\": XFCE LTS Edition (32 or 64-bit). MINIMUM Guest VM requirements are 512MB of RAM and 10GB of available disk space. OPTIMUM Guest VM requirements are 1024MB of RAM and 20GB of available disk space. The installer media can be downloaded from http://www.linuxmint.com/download.php" \
