...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Linux Mint \"Debian Edition\"")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE for Linux Mint \"Debian Edition\": rolling-update release (32 or 64-bit).  MINIMUM Guest VM requirements are 512MB of RAM and 10GB of available disk space.  OPTIMUM Guest VM requirements are 1024MB of RAM and 20GB of available disk space.  The installer media can be downloaded from http://www.linuxmint.com/release.php?id=14" \
